...
public interface PilaTDA {
 ...
 void desapilar();//elimina un elemento de la pila, la misma no debe estar vacia
 int tope();//devuelve el primer elemento de la pila, la misma no debe estar vacia
 boolean pilaVacia();//indica si la pila esta vacia//la pila debe estar inicializada
}
